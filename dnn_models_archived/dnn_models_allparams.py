...
class Sinc_Conv2d_attention_prenew3param(nn.Module):
    # class global variables
    # filter_length = 251
    filter_length = 131
    t_length = 500
    ...
    def __init__(self, dropout):
        super(Sinc_Conv2d_attention_prenew3param, self).__init__()
        self.b0 = nn.BatchNorm2d(1, momentum=0.99)
        self.sinc_cnn2d = sinc_conv(32, self.filter_length, 500)
        # self.fc1 = torch.nn.Linear(495,495)
        self.b =  nn.BatchNorm2d(32, momentum=0.99)
    ...
    def forward(self, x):
        ...
        return score3,score4,(score2,y0,score0_), score5   #score5 is ndt
...
class Sinc_Conv2d_attention_prenew4param(nn.Module):
    # class global variables
    # filter_length = 251
    filter_length = 131
    t_length = 500
    ...
    def __init__(self, dropout):
        super(Sinc_Conv2d_attention_prenew4param, self).__init__()
        self.b0 = nn.BatchNorm2d(1, momentum=0.99)
        self.sinc_cnn2d = sinc_conv(32, self.filter_length, 500)
        # self.fc1 = torch.nn.Linear(495,495)
        self.b =  nn.BatchNorm2d(32, momentum=0.99)
        ...
        self.fc4 =  torch.nn.Linear(32*3*self.output_size,1)
        self.fc5 = torch.nn.Linear(32 * 3 * self.output_size, 1)
        self.fc6 = torch.nn.Linear(32 * 3 * self.output_size, 1)
    ...
    def forward(self, x):
        ...
        # score4 = self.fc4(score2)
        # score4 = F.sigmoid(self.fc4(score2)) *3    # right now uses sigmoid
        score4 = F.sigmoid(self.fc4(score2))*2
        score5 = F.sigmoid(self.fc5(score2))
        score6 = 0.5* (F.tanh(self.fc6(score2)) +1) * score4
        return score3,score4,(score2,y0,score0_), score5,score6   #score5 is ndt
