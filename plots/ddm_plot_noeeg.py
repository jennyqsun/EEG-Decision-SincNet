...
# %Approximate by X_t(t+dt) = X_t(t) + mu*dt + sigma*sqrt(dt)*randn
    ...
    ylim = ax.get_ylim()
    ax.plot([tau/2 *1000, tau/2*1000], (0,alpha) ,linewidth=2, color='tab:green')
...
# transform=fig.transFigure, horizontalalignment='center', fontsize=20, weight='bold')
    ...
    fig.text(0.15,0.55+0.15,'Choice 1', fontsize = 15)
    fig.text(0.15, 0.22, 'Choice 2', fontsize=15)
    fig.text(0.02, 0.28+0.1, 'Evidence \nAccumulation', fontsize=15, rotation=90)
    # fig.text(0.05, 0.60, 'Single Trial\n EEG Amplitude', fontsize=15, rotation=90)
    fig.text(0.1, 0.50+0.12, r'$\alpha$', fontsize=18)
    fig.text(0.1, 0.25+0.05, r'$0$', fontsize=18)
    fig.text(0.08, 0.37+0.1, r'$\beta\alpha$', fontsize=18)
    fig.text(0.22, 0.5, r'$\delta$', fontsize=18)
    fig.text(0.23, 0.37, r'$\varsigma$', fontsize=18)
    ...
    fig.savefig('/home/jenny/Downloads/ddm_plot.png')
